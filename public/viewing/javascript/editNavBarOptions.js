...
function saveNavOptions() {
        ...
        if (navItemOption.id == "newNavOption") {
          ...
          try {
            ...
            newPages[navItemOption.value].content =
              pagesJSON[navItemOption.value].content;
            newPages[navItemOption.value].imgId =
              pagesJSON[navItemOption.value].imgId;
          } catch (err) {
            newPages[navItemOption.value].content = [];
          ...
          newPages[navItemOption.value] = { content: [], imgId: null };
          newPages[navItemOption.value].content =
            pagesJSON[navItemOption.id].content;
          newPages[navItemOption.value].imgId =
            pagesJSON[navItemOption.id].imgId;
        }
      }
    });
  });
  ...
  fetch("/editNavBarOptions?id=" + encodeURIComponent(id), {
    ...
    body: JSON.stringify({ newNavItems, newPages, mapMarkers }),
  }).then((response) => {
