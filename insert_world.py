...
query = 'INSERT INTO worlds ( worldName, mainPage, pages, img1Id, img2Id, NavItems, mapMarkers, public, ownerId) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s);'
VALUES = (worldName, mainPage, pages, img1Id, img2Id, navItems, mapMarkers, public, ownerId)
